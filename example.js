...
(async () => {
    let arr = [{ id: 1, sub: [1, 2, 3, 4, 5, 6], value: false }, { id: 2, sub: [1, 2, 3, 4, 5], value: false }, { id: 3, sub: [1, 2, 3, 4, 5], value: false }, { id: 4, sub: [1, 2, 3, 4, 5], value: false }, { id: 5, sub: [1, 2, 3, 4, 5], value: false }];

    setInterval(function () {
        console.log(arr.filter(x => x.value == true).length);
    }, 3000);

    arr.forEach(async function (main, index, array) {

        main.sub.forEach(async function (sub, index, array) {
